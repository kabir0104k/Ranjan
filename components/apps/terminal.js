...
export class Terminal extends Component {
    constructor() {
        ...
        this.child_directories = {
            root: ["Tools", "Payloads", "CVE", "CheatSheet"],
            Tools: ["Nmap", "LDAP", "Hydra", "Hashcat"],
            Payloads: ["Front-end development", "React.js", "jQuery", "Flutter", "Express.js", "SQL", "Firebase"],
            CVE: ["CVE"],
        ...
        switch (main) {
            ...
            case "code":
                if (words[0] === "." || words.length === 0) {
                    ...
                    result = "Command '" + main + "' not found <br>Available Commands:[ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome,  todoist, trash, settings, sendmsg]";
                }
                break;
            case "echo":
